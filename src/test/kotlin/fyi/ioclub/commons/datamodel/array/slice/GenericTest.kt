...
import fyi.ioclub.commons.datamodel.array.slice.GenericArraySlice as TestArraySlice

private fun createArray3() = arrayOf("0", "1", "2")
...
class GenericTest {
    ...
    fun test() {
        ...
        val d = object : TestArraySlice.Delegate<String> {
        ...
        assertEquals(a3.contentDeepHashCode(), s3.contentDeepHashCode())
        assertTrue((a3.arrayIterator().asSequence() zip s3.arrayIterator().asSequence()).all { (a, b) -> a == b })
        assertTrue(
        ...
        assertEquals(s3.arrayIndexOf(a31), s3.arrayBinarySearch(a31, String::compareTo))
