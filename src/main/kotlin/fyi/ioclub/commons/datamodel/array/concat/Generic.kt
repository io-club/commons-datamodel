...
fun <T> concat(clazz: Class<T>, source1: ArraySlice<T>, source2: ArraySlice<T>) =
    concat(source1, source2, destinationFactoryOf(clazz))

fun <T> concat(clazz: Class<T>, source1: ArraySlice<T>, source2: ArraySlice<T>, vararg sourceN: ArraySlice<T>) =
    concat(source1, source2, destinationFactoryOf(clazz))

fun <T> concat(clazz: Class<T>, sources: Collection<ArraySlice<T>>) = concat(sources, destinationFactoryOf(clazz))
